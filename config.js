...
let bylineDiv =
  '<p class="neue-font text-center text-sm max-w-3xl mx-auto mb-14 leading-relaxed text-gray-600">Melissa Checker, Juan Francisco Saldarriaga, Glen Johnson, Alex Mendell, and Mariana Mogilevich • June 29, 2022</p>';
...
let divChapter6 =
  ...
  '<p class="neue-font text-left text-base max-w-3xl mx-auto mt-6 leading-relaxed">Between December 2017 and December 2018, the median sales price for a residential property in Greenpoint rose by 37 percent to $1,225,000, making it the third most expensive neighborhood in Brooklyn. In April 2022, <a class="underline underline-offset-4" href="https://www1.nyc.gov/assets/planning/download/pdf/about/dcp-priorities/data-expertise/nyc-foreign-born-info-brief.pdf?r=1" target="_blank" rel="noopener noreferrer">the median sale price in Greenpoint was 1.35 million and the median rent for a one-bedroom was $3,500</a> (median rent in Brooklyn was $2,600).</p>' +
...
let divChapter7b =
  '<div class="text-gray-800 p-6"><p class="neue-font text-left text-base max-w-3xl mx-auto leading-relaxed">A recent NYC Department of City Planning study found approximately <span class="bg-green-400 px-1 rounded text-white">41 potential brownfield sites</span> in Port Richmond. The study was one of about a dozen redevelopment proposals produced for the area over the last twelve years. However, to date, few initiatives from those plans have been implemented and the area\'s prospects for redevelopment remain elusive. Only one property in Port Richmond has enrolled in the <span class="bg-teal-600 text-white px-1 rounded">Voluntary Cleanup Program</span>.</p>' +
...
let divChapter8 =
  ...
  '<p class="neue-font text-left leading-relaxed text-base mt-5">Looking at the city in its entirety, we find that VCP sites cluster in neighborhoods that score high on our gentrification index, like Greenpoint, as well as Williamsburg, West Chelsea, Long Island City and others.</p>' +
...
let divChapter9 =
  '<div class="text-gray-800 p-6"><p class="neue-font text-left leading-relaxed text-base mt-1">Here is how <span class="bg-rose-500 text-white px-1 rounded">gentrification</span> overlaps with the <span class="bg-teal-600 text-white px-1 rounded">Voluntary Cleanup Program</span> sites.</p>' +
  ...
  '<p class="neue-font text-left leading-relaxed text-base mt-5">Can we create safer and healthier neighborhoods while avoiding "brown gentrification"?</p>' +
  "</div>";
...
let footerDiv = 
  ...
  '<p class="neue-font text-left text-lg max-w-3xl mx-auto mt-6 leading-relaxed"><span class="font-semibold">Mariana Mogilevich</span> is Editor in Chief of Urban Omnibus.</p>' +
  ...
  '<p class="neue-font text-left text-lg max-w-3xl mx-auto mt-10 leading-relaxed">The views expressed here are those of the authors only and do not reflect the position of The Architectural League of New York.</p>' +
  '</div>' +
  "</div>";
