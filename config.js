...
let divChapter1 =
  '<div class="p-6"><p class="neue-font text-left text-base">E-DESIGNATIONS</p>' +
...
let divChapter2 =
  '<div class="p-6"><p class="neue-font text-left text-base">UPZONING IN RESIDENTIAL DISTRICTS</p>' +
...
let divChapter3 =
  '<div class="p-6"><p class="neue-font text-left text-base">THROUGH DIFFERENT ADMINISTRATIONS</p>' +
...
let divChapter4 =
  '<div class="p-6"><p class="neue-font text-left text-base">UPZONING IN GREENPOINT</p>' +
...
let divChapter5 =
  '<div class="p-6"><p class="neue-font text-left text-base">VOLUNTARY CLEANUP PROGRAM</p>' +
  ...
  let divChapter6 =
  '<div class="p-6"><p class="neue-font text-left text-base">CLEANING UP GREENPOINT - E-DESIGNATIONS</p>' +
  ...
  let divChapter7 =
  '<div class="p-6"><p class="neue-font text-left text-base">CLEANING UP GREENPOINT - VOLUNTARY CLEANUP SITES</p>' +
  ...
  let divChapter8 =
  '<div class="p-6"><p class="neue-font text-left text-base">PORT RICHMOND</p>' +
