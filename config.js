...
let divChapter6 =
  ...
  '<p class="neue-font text-left text-base max-w-3xl mx-auto mt-6 leading-relaxed">Between December 2017 and December 2018, the median sales price for a residential property in Greenpoint rose by 37 percent to $1,225,000, making it the third most expensive neighborhood in Brooklyn. In April 2022, the <a class="underline underline-offset-4" href="https://www1.nyc.gov/assets/planning/download/pdf/about/dcp-priorities/data-expertise/nyc-foreign-born-info-brief.pdf?r=1" target="_blank" rel="noopener noreferrer">median sale price in Greenpoint was 1.35 million and the median rent for a one-bedroom was $3,500</a> (median rent in Brooklyn was $2,600).</p>' +
...
let divChapter7b =
  '<div class="text-gray-800 p-6"><p class="neue-font text-left text-base max-w-3xl mx-auto leading-relaxed">To date, only one property in Port Richmond has enrolled in the <span class="bg-teal-600 text-white px-1 rounded">Voluntary Cleanup Program</span>.</p>' +
  '<p class="neue-font text-left text-base max-w-3xl mx-auto mt-6 leading-relaxed">Importantly, Port Richmond remains a dense, low income and working class neighborhood, as well as home to one of the city\'s fastest growing immigrant populations. <a class="underline underline-offset-4" href="https://www.osc.state.ny.us/files/reports/osdc/pdf/report-7-2019.pdf" target="_blank" rel="noopener noreferrer">Between 2000 and 2017, Staten Island\'s immigrant population increased by 57 percent, five times faster than the citywide growth rate</a> and faster than in any other borough. The vast majority of immigrants are concentrated in Port Richmond and its surrounding neighborhoods.</p>' +
  '<p class="neue-font text-left text-base max-w-3xl mx-auto mt-6 leading-relaxed">In April 2022, the median listing home price in Port Richmond was <a class="underline underline-offset-4" href="https://www.realtor.com/realestateandhomes-search/Port-Richmond_Staten-Island_NY/overview" target="_blank" rel="noopener noreferrer">$499,000</a>, remaining relatively flat from the previous three years. Average rent for a <a class="underline underline-offset-4" href="https://www.zumper.com/rent-research/staten-island-ny" target="_blank" rel="noopener noreferrer">one-bedroom was $1,500</a> (compared to $1,525 in Staten Island), a slight decrease from the previous year.</p>' +
...
let footerDiv = 
  '<div class="text-gray-800 py-10"><p class="fort-font text-left text-base sm:text-lg max-w-3xl mx-auto sm:px-0 px-4">Notes</p>' +
  '<p class="neue-font text-left text-base sm:text-lg max-w-3xl mx-auto mt-6 leading-relaxed sm:px-0 px-4">The index of gentrification is based on a composite score that increases with increasing relative change of key variables (median family income, median rent and proportions of non-Hispanic white, 20-34-year-olds and adults with a 4-year college degree) computed from the years 2000 to 2019 for NYC census tracts that are spatially normalized to the year 2010. These community-level input variables were chosen to represent the nuanced and processual nature of the socioeconomic and demographic shifts associated with gentrification.</p></div>' +
  '<div class="text-gray-800 py-10"><p class="fort-font text-left text-base sm:text-lg max-w-3xl mx-auto sm:px-0 px-4">Data Sources</p>' +
  '<p class="neue-font text-left text-base sm:text-lg max-w-3xl mx-auto mt-6 leading-relaxed sm:px-0 px-4"><ul class="list-disc max-w-3xl mx-auto pl-8 sm:pl-4 pr-4 text-base sm:text-lg">' +
  ...
  '<p class="neue-font text-left text-base sm:text-lg max-w-3xl mx-auto mt-10 leading-relaxed sm:px-0 px-4">The views expressed here are those of the authors only and do not reflect the position of The Architectural League of New York.</p>' +
  '</div>' +
  "</div>";
